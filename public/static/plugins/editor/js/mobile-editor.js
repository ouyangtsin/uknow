(function (global, factory) {
  ...
  function ExpansionPanel(options, zxEditor) {
    ...
    this.$el = $("<div class=\"zx-editor-expansion-panel\"></div>"); // click
    // stop propagation
  ...
  function Toolbar(options, zxEditor) {
    ...
    this.$el = $("<div class=\"zx-editor-toolbar-wrapper ".concat(this.visible ? 'in' : 'out', "\" style=\"height:").concat(this.height + (util.isIPhoneX ? IPHONEX_BOTTOM_OFFSET_HEIGHT : 0), "px;\"><dl class=\"inner-wrapper\" style=\"height:").concat(this.height, "px;\"></dl></div>")); // append to $editor
    zxEditor.$editor.append(this.$el); // init
    this.init(options);
  }
