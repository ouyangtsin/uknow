{if !$step}
<h3 class="text-center mb-2 mt-4">身份验证</h3>
<p class="text-color-info text-center font-9">
    为了保护你的帐号安全，请验证身份，<br>验证成功后进行下一步操作
</p>
<form class="p-3" action="" id="verify" style="height: 186px">
    ...
    <div class="overflow-hidden px-4">
        <button class="btn btn-primary w-100 verify-btn" type="button">验证</button>
    </div>
</form>
<script>
    $(function(){
...
{if $step==1}
<h3 class="text-center mb-2 mt-4">更改手机号</h3>
<p class="text-color-info text-center font-9">
    请验证您的手机号，<br>验证成功后进行下一步操作
</p>
<form class="p-3" action="" style="height: 186px">
    <input type="hidden" name="step" value="1">
    <input type="hidden" name="uid" value="{$user_id}">
    <div class="form-group">
        <input type="text" class="form-control border-0 border-bottom" name="mobile" placeholder="输入输入新的手机号" value="">
    </div>
    <div class="form-group">
        <label>
            <input type="text" class="form-control border-0 border-bottom verify-text" name="sms_code" placeholder="输入您的短信验证码" value="">
        </label>
        <button class="btn btn-primary btn-sm px-4 send-sms" type="button">获取验证码</button>
    </div>
