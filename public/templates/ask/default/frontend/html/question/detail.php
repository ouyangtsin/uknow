<div id="uk-question-fixed" class="bg-white fixed-top d-xs-none" style="display: none">
    <div class="container overflow-hidden">
        <h3 class="mb-0 float-left">{$question_info.title}</h3>
                            ...
                            <div class="uk-popover mod-head-more">
                                ...
                                <div class="popover-content">
                                    <div class="text-center d-block py-2 uk-nav uk-dropdown-nav text-center uk-answer-sort" style="min-width: 100px">
                                        <div class="{$sort=='new' ? 'active':''} py-1"><a href="{:url('ask/question/detail',['id'=>$question_info['id'],'sort'=>'new'])}"  data-pjax="answer-container">默认排序</a> </div>
                                        <div class="{$sort=='hot' ? 'active':''} py-1"><a href="{:url('ask/question/detail',['id'=>$question_info['id'],'sort'=>'hot'])}"  data-pjax="answer-container">热门排序 </a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="answer-btn-actions mt-3">
                                ...
                                <label class="mr-3">
                                    <a href="javascript:;"  {if $v.has_thanks} class="active" {else/}onclick="UK.User.thanks(this,'{$v.id}')"{/if}>
                                        <i class="icon-favorite"></i> <span>{$v.has_thanks ? '已感谢' : '感谢'}</span>
                                    </a>
                                </label>
                                ...
                                <div class="mr-3 uk-popover d-inline-block">
                                    ...
                                    <div class="popover-content">
                                        <div class="text-left d-block py-2" style="min-width: 100px">
                                            <a href="javascript:;"  class="dropdown-item uk-clipboard" data-clipboard-text="{:url('ask/question/detail',['answer'=>$v.id,'id'=>$question_info.id],true,true)}"><i class="icon-link"></i> 复制链接</a>
                                            <a href="javascript:;" onclick="UK.User.share('{$question_info.title}','{:url('ask/question/detail',['answer'=>$v.id,'id'=>$question_info.id],true,true)}','','weibo')" class="dropdown-item "><i class="iconfont icon-weibo text-warning"></i> 新浪微博</a>
                                            <a href="javascript:;" onclick="UK.User.share('{$question_info.title}','{:url('ask/question/detail',['answer'=>$v.id,'id'=>$question_info.id],true,true)}','','qzone')" class="dropdown-item "><i class="iconfont icon-QQ text-primary"></i> 腾讯空间</a>
                                            <div class="uk-qrcode-container" data-share="{:url('ask/question/detail',['answer'=>$v.id,'id'=>$question_info.id],true,true)}">
                                                <a href="javascript:;" class="dropdown-item "><i class="iconfont icon-weixin text-success"></i> 微信扫一扫</a>
                                                <div class="uk-qrcode text-center py-2"></div>
                                            </div>
                                        </div>
