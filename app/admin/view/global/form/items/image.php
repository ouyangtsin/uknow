<div class="row dd_input_group {$form[type].extra_class|default=''}" id="form_group_{$form[type].name}">
    ...
    <div class="col-12 col-md-6 col-lg-6 dd_ts">
        ...
        <a href="{$form[type].value ?: '/static/common/image/default-cover.svg'}" target="_blank">
...
<script type="text/javascript">
    webupload('fileList_{$form[type].name}', 'filePicker_{$form[type].name}', '{$form[type].name}_preview', '{$form[type].name}', false, '{$config.upload_image_ext|default=""}', '{$config.upload_image_size|default="0"}');
</script>
