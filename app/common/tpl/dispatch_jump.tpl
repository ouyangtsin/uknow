...
<head>
    ...
    <style type="text/css">
        *{box-sizing:border-box;margin:0;padding:0;font-family:Lantinghei SC,Open Sans,Arial,Hiragino Sans GB,Microsoft YaHei,"微软雅黑",STHeiti,WenQuanYi Micro Hei,SimSun,sans-serif;-webkit-font-smoothing:antialiased}
        ...
        .system-message{margin:20px 25%;padding:40px 20px;background:#fff;box-shadow:0px 0px 10px hsla(0,0%,39%,.1);text-align:center;border-radio:5px}
...
?>
    <div class="system-message {$codeText}">
        <div class="image">
            <img src="/static/image/{$codeText}.svg" alt="" width="150" />
        </div>
